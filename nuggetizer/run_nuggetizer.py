#!/usr/bin/env python3
"""Extract importance-labeled nuggets from source documents and score how well
a response supports them.
...
def main():
    parser = argparse.ArgumentParser(description="Run nuggetizer over a dataset/subset/prompt condition.")

...
def main():
    ...
    set_alpha = 0.9
    dim = (8, 5)
    base_dir = "analysis/figures/final_presentation"


    fig2, ax2 = create_comparison_chart(
        results_df,
        ...
        metric1_label='Factscore',
        metric2_label='Vital Prec.',
        metric3_label='LD Prec.',
        chart_title='Precision Metrics',
        # secondary_axis_title='Dataset Group Comparison',
        figsize=dim,
        set_alpha=set_alpha,
        three_colors=three_colors
    )
    plt.savefig(base_dir + r'\precision.pdf', format="pdf")
    # plt.show()
    ...
    fig2, ax2 = create_comparison_chart(
        ...
        dataset1=['factscore', 'wildhallucinations', 'bright'],
        dataset2=['hotpotqa', 'naturalquestions', 'triviaqa'],
        metric1_col='nuggets-strict-all',
        metric2_col='nuggets-vital-recall',
        metric3_col='linear-decay-recall',
        dataset1_label='Open-Ended', 
        dataset2_label='Single-Answer',
        metric1_label='Nuggets Recall',
        metric2_label='Vital Recall',
        metric3_label='LD Recall',
        chart_title='Recall Metrics',
        # secondary_axis_title='Dataset Group Comparison',
        figsize=dim,
        set_alpha=set_alpha,
        three_colors=three_colors
    )
    plt.savefig(base_dir + r'\recall.pdf', format="pdf")
    # plt.show()
    ...
    plt.savefig(base_dir + r'\errors.pdf', format="pdf")
    #plt.show()
    ...
    plt.savefig(base_dir + r'\counts.pdf', format="pdf")
    # plt.show()

"""Run FactScore-style decomposition + verification over a data.jsonl file.
...
def main():
    parser = argparse.ArgumentParser(description="Run FactScore over a dataset/subset/prompt condition.")
    ...
    with open(in_file, "r") as input, open(out_file, "w") as output:
        for line in tqdm(input):
            ...
            docs = [d["text"] for d in line["documents"]]
